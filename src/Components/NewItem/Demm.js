    ...
    return (
        ...
        <Draggable bounds={{top: -100, left: -100, right: 100, bottom: 100}} {...dragHandlers}>
          <div className="box">I can only be moved 100px in any direction.</div>
            ...
            <div className="box" style={{ height: '500px', width: '95%', position: 'relative', overflow: 'auto', padding: '0', backgroundColor: 'yellow' }}>
                <div style={{ height: '1000px', width: '95%', padding: '10px', backgroundColor: 'red' }}>
